...
if(isset($_GET['txtID'])) {
    ...
    if(isset($registro_imagen) && is_array($registro_imagen) && isset($registro_imagen['imagen'])) {
        ...
        // elimina bd
        $sentencia_eliminar = $conexion->prepare("DELETE FROM tlb_clientes WHERE ID=:id");
...
$sentencia = $conexion->prepare("SELECT * FROM `tlb_clientes`");
$sentencia->execute();
        ...
        <table
            ...
            <?php foreach ($lista_clientes as $key  => $value) { ?>
                <tr class="">
                    ...
                    <td>
                    <img src="../../../images/clientes/<?php echo $value['imagen']?>" width="50" alt=""> 
                    </td>
                    <td>
